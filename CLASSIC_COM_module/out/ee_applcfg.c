...
static VAR(OsEE_SN, OS_VAR_INIT)  osEE_sn_array[11] = {
  {
...
VAR(OsEE_CDB, OS_CONST) osEE_cdb_var = {
  /* .p_ccb                         = */ &osEE_ccb_var,
  /* .p_idle_task                   = */ &osEE_tdb_array[11U],
