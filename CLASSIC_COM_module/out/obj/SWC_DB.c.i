# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.c"
...
# 3 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.c" 2
# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.h" 1
# 9 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.h"
#define BSW_COM_SWC_DB_H_ 

# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\ECU_config.h" 1
...
# 12 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.h" 2
# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\CAN_DB.h" 1
# 9 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\CAN_DB.h"
...
# 46 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\CAN_DB.h"
 unsigned char name[33];
 int length;
 char byte_order;
 char value_type;
...
extern SIG_OB signals[5];
extern MSG_OB messages[3];
extern NODE_OB nodes[3];
...
typedef struct signal_to_txmsg_mapping {
 int msg_cnt;
 int msg_id_list[3];
 int start_bit_list[3];
} SIG_TO_TXMSG_M;

extern MSG_IN_SIG_M msg_in_sig_M[3];

extern char tx_msgid_to_tx_MsgObjId[3];
extern char rx_msgid_to_rx_MsgObjId[3];

extern char is_rx_msg[3];
extern char is_tx_msg[3];
extern char is_tx_sig[5];
extern SIG_TO_TXMSG_M sig_to_tx_msg[5];
# 13 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.h" 2
...
# 49 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.h"
extern IM* IM_block[2];
...
# 4 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.c" 2
...
# 5 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.c" 2
# 25 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.c"
void IM1_act_task() {
 ActivateTask((4U));
}
...
IM* IM_block[2] = {&im_IsDark, &im_IsIntunnel};

int IM_to_SIG_M[2] = {0,1};
int SIG_to_IM[5];
# 52 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\SWC_DB.c"
void swc_db_init(void) {

 for(int i = 0; i < 5; i++) SIG_to_IM[i] = -1;
 for(int i = 0; i < 2; i++) {
