# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxScuCcu.c"
...
#define __HAVE_SHORT_DOUBLE__ 1
# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxScuCcu.c"
# 49 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxScuCcu.c"
...
# 125 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxscuccu.h" 2 3
...
# 126 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxscuccu.h" 2 3
...
# 50 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxScuCcu.c" 2
# 63 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxScuCcu.c"
...
# 80 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxScuCcu.c"
...
const IfxScuCcu_Config IfxScuCcu_defaultClockConfig = {
    ...
    {( ((6 - 1) << (0u)) | ((2 - 1) << (4u)) | ((10 - 1) << (6u)) | ((2 - 1) << (12u))), ( ((0xfu) << (0u)) | ((0x3u) << (4u)) | ((0x3fu) << (6u)) | ((0x7u) << (12u)))},
    (20000000),
};
...
void IfxScuCcu_enableExtClockOut0(IfxScuCcu_ClkSel0 Clk_Sel, const uint32 freqHz, IfxScuCcu_Clk0Mode mode)
{
    ...
    (*(volatile Ifx_SCU_EXTCON*)0xF003603Cu).B.SEL0 = (uint32)Clk_Sel;
    ...
    if (IfxScuCcu_ClkSel0_fOUT == Clk_Sel)
    {
        if (mode == IfxScuCcu_Clk0Mode_normal)
        {
            ...
            (*(volatile Ifx_SCU_FDR*)0xF0036038u).B.DM = 1U;

            if (freqHz == (IfxScuCcu_getSpbFrequency() / 2))
            {
                (*(volatile Ifx_SCU_FDR*)0xF0036038u).B.STEP = 0x3FFu;
            }
            else
            {
                (*(volatile Ifx_SCU_FDR*)0xF0036038u).B.STEP = (uint32)(1024u - (IfxScuCcu_getSpbFrequency() / (2u * freqHz)));
            }
        }
        else
        {

            (*(volatile Ifx_SCU_FDR*)0xF0036038u).B.DM = 2U;
            (*(volatile Ifx_SCU_FDR*)0xF0036038u).B.STEP = (uint32)(((2u * freqHz) * 1024u) / (IfxScuCcu_getSpbFrequency()));
        }
    }

    (*(volatile Ifx_SCU_EXTCON*)0xF003603Cu).B.EN0 = 1U;
    IfxScuWdt_setSafetyEndinit(endinitSfty_pw);
}
...
void IfxScuCcu_enableExtClockOut1(IfxScuCcu_ClkSel1 Clk_Sel, const uint32 freqHz, IfxScuCcu_Clk1Negation sel)
{
    ...
    (*(volatile Ifx_SCU_EXTCON*)0xF003603Cu).B.SEL1 = (uint32)Clk_Sel;

    if (IfxScuCcu_ClkSel1_fOUT == Clk_Sel)
    {
        (*(volatile Ifx_SCU_EXTCON*)0xF003603Cu).B.DIV1 = (uint32)((IfxScuCcu_getSpbFrequency() / freqHz) - 1U);
        (*(volatile Ifx_SCU_EXTCON*)0xF003603Cu).B.NSEL = sel;
    }

    (*(volatile Ifx_SCU_EXTCON*)0xF003603Cu).B.EN1 = 1U;
    IfxScuWdt_setSafetyEndinit(endinitSfty_pw);
}
