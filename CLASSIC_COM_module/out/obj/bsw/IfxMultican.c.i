# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
...
#define __HAVE_SHORT_DOUBLE__ 1
# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
# 48 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
...
# 57 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxmultican_cfg.h" 2 3
...
# 44 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\IfxCan_regdef.h" 2 3
...
# 114 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxsrc.h" 2 3
...
# 62 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxport.h" 2 3
...
# 51 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxmultican_pinmap.h" 2 3
...
# 71 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\tricore\\include\\tc27xd\\ifxmultican.h" 2 3
...
# 49 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c" 2
#define NULL_PTR ((void *)0)
# 61 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
...
boolean IfxMultican_MsgObj_getStatusFlag(Ifx_CAN_MO *hwObj, IfxMultican_MsgObjStatusFlag flag)
{
    ...
    return (hwObj->STAT.U & shift) ? (1u) : (0u);
}
...
IfxMultican_Status IfxMultican_MsgObj_readLongFrame(Ifx_CAN *mcan, IfxMultican_MsgObjId msgObjId, IfxMultican_Message *msg, uint32 *data)
{
    ...
    boolean longFrame = (hwObj->FCR.B.FDF != 0) ? (1u) : (0u);
...
# 719 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
...
void IfxMultican_Node_setFastBitTiming(Ifx_CAN_N *hwNode, float32 moduleFreq, uint32 baudrate, uint16 samplePoint, uint16 synchJumpWidth)
{
    ...
    sint32 bestBRP = 0, bestSJW = 1, bestTBAUD = 8, bestTSEG1 = 3, bestTSEG2 = 2;
    float32 bestError = 10000.0f;
# 878 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
    bestError = baudrate * 0.05f;
...
void IfxMultican_Node_setNominalBitTiming(Ifx_CAN_N *hwNode, float32 moduleFreq, uint32 baudrate, uint16 samplePoint, uint16 synchJumpWidth)
{
    ...
    sint32 bestBRP = 0, bestSJW = 1, bestTBAUD = 8, bestTSEG1 = 3, bestTSEG2 = 2;
    float32 bestError = 10000.0f;
# 1035 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\bsw\\IfxMultican.c"
    bestError = baudrate * 0.05f;
