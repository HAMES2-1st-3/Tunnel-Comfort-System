# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 1 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
# 48 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 49 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c" 2
# 1222 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
#define OSEE_TC_TRAP_WORKAROUND() __asm__ ("")


#define OSEE_TC_TRAP_DEFINITION2(t,h) __asm__ (".globl " OSEE_S(t)); __asm__ (OSEE_S(t) ":"); OSEE_TC_TRAP_WORKAROUND(); __asm__ ("svlcx"); __asm__ ("movh.a %a15,hi:" OSEE_S(h)); __asm__ ("lea %a15,[%a15]lo:" OSEE_S(h)); __asm__ ("mov %d4,%d15"); __asm__ ("ji %a15"); __asm__ (".align 5");
# 1237 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
#define OSEE_TC_TRAP_DEFINITION(t,h) OSEE_TC_TRAP_DEFINITION2(t,h)

#define OSEE_TC_TRAP_DEFINITION_WITH_CALL(t,h) __asm__ (".globl " OSEE_S(t)); __asm__ (OSEE_S(t) ":"); OSEE_TC_TRAP_WORKAROUND(); __asm__ ("svlcx"); __asm__ ("movh.a %a15,hi:" OSEE_S(h)); __asm__ ("lea %a15,[%a15]lo:" OSEE_S(h)) __asm__ ("mov %d4,%d15"); __asm__ ("calli %a15"); __asm__ ("rslcx"); __asm__ ("rfe"); __asm__ (".align 5");
# 1253 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
#define OSEE_TC_TRAP_DEFAULT(t) __asm__ (".globl " OSEE_S(t)); __asm__ (OSEE_S(t) ":"); OSEE_TC_TRAP_WORKAROUND(); __asm__ ("debug"); __asm__ ("j " OSEE_S(t)); __asm__ (".align 5");
# 1272 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
__asm__ ("                                  \n  .section .traptab_cpu0, \"ax\", @progbits \n  .align 8                                  \n  .globl _exit                              \n  .globl __TRAPTAB                          \n__TRAPTAB:                                  \n");
# 1287 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
__asm__ (".globl " "osEE_tc_trap_mmu"); __asm__ ("osEE_tc_trap_mmu" ":"); __asm__ (""); __asm__ ("debug"); __asm__ ("j " "osEE_tc_trap_mmu"); __asm__ (".align 5");
# 1298 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 1307 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 1316 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 1327 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
__asm__ (".globl " "osEE_tc_trap_bus"); __asm__ ("osEE_tc_trap_bus" ":"); __asm__ (""); __asm__ ("debug"); __asm__ ("j " "osEE_tc_trap_bus"); __asm__ (".align 5");
# 1336 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 1365 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
...
# 1374 "D:\\Workspace\\autoever_osek\\can_based_OSEK_OS_TEST\\erika\\src\\ee_tc_trapvec.c"
