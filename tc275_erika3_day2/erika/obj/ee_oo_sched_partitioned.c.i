# 1 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
...
# 1 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
# 54 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
...
# 55 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c" 2
...
# 133 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
  if (p_curr_tcb->current_prio < p_tcb_act->current_prio) {
    OsEE_SN * const
      p_new_stk = osEE_sn_alloc(&p_ccb->p_free_sn);
# 149 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
...
)
{
  ...
  (void)p_kdb;
  osEE_lock_core(p_cdb);
# 213 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
  {
...
# 250 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
OsEE_bool
  osEE_scheduler_task_unblocked
(
  OsEE_KDB * p_kdb,
...
)
{
  ...
  osEE_unlock_core(p_cdb);
# 301 "C:\\TC275_~2\\erika\\src\\ee_oo_sched_partitioned.c"
  return is_preemption;
}
