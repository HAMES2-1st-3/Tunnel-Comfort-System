# 1 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 1 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
# 53 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 54 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c" 2
...
# 300 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    p_ccb->os_status = OSEE_KERNEL_STARTING;
    p_ccb->app_mode = real_mode;
# 389 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    osEE_call_startup_hook(p_ccb);
# 398 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
      MemSize i;
...
# 460 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
      }
    }
...
# 527 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    ...
    for(;;) {}
# 572 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  }
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 655 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 691 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 745 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ev = E_OS_ID;
  } else {
    OsEE_TDB * const
      p_tdb_act = (*p_kdb->p_tdb_ptr_array)[TaskID];
# 771 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    if (p_tdb_act->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      OsEE_reg flags;
...
# 819 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  OsEE_TDB * const
    p_curr = p_ccb->p_curr;
# 898 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  {
    OsEE_reg flags;
...
# 934 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1003 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 1034 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1083 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  ...
  } else
  {
    ...
    OsEE_reg
      flags = osEE_begin_primitive();
# 1117 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
...
# 1146 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1191 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_res_id(p_kdb, ResID)) {
    ev = E_OS_ID;
  } else
  {
    ...
    OsEE_ResourceCB * const
      p_reso_cb = p_reso_db->p_cb;
# 1213 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
      OsEE_reg
        flags = osEE_begin_primitive();
...
# 1256 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1304 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  {
    if ((os_status == OSEE_KERNEL_STARTED) ||
...
# 1323 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1373 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (TaskID == ((void *)0)) {
    ...
    OsEE_TDB * const
      p_tdb = p_ccb->p_curr;
# 1389 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 1428 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1479 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (State == ((void *)0)) {
    ev = E_OS_PARAM_POINTER;
  } else
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
...
# 1526 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1575 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 1595 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
      OsEE_reg const
        flags = osEE_begin_primitive();
...
# 1618 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1666 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else
  {
    ...
    OsEE_CounterDB * const
      p_counter_db = osEE_alarm_get_trigger_db(p_alarm_db)->p_counter_db;
# 1685 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
      OsEE_reg const
        flags = osEE_begin_primitive();
...
# 1708 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1754 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else {
    OsEE_AlarmDB * const
...
# 1778 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1825 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else
  if (Tick == ((void *)0)) {
...
# 1854 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1901 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else
  if (Info == ((void *)0)) {
...
# 1932 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2002 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  {
...
# 2044 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  OsEE_CDB * const
    p_cdb = osEE_get_curr_core();
# 2101 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  osEE_stack_monitoring(p_cdb);
...
# 2140 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  OsEE_CDB * const
    p_cdb = osEE_get_curr_core();
# 2200 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  osEE_stack_monitoring(p_cdb);
...
# 2220 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    if (Event == ((void *)0)) {
      ev = E_OS_PARAM_POINTER;
    } else
    {
...
# 2246 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2298 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  {
...
# 2323 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2374 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
# 2392 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
# 2407 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
      (*Value) = p_counter_db->p_counter_cb->value;

      ev = E_OK;
    }
  }
# 2425 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2474 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_counter_id(p_kdb, CounterID)) {
    ev = E_OS_ID;
  } else
  ...
  } else
  {
    ...
    TickType const
      local_value = (*Value);
# 2503 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
...
# 2543 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2592 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_counter_id(p_kdb, CounterID)) {
    ev = E_OS_ID;
  } else
  {
    OsEE_CounterDB * const
      p_counter_db = (*p_kdb->p_counter_ptr_array)[CounterID];
# 2607 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
    {
# 2617 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
      OsEE_reg const flags = osEE_begin_primitive();
...
# 2647 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
  osEE_orti_trace_service_exit(p_ccb, OSServiceId_IncrementCounter);

  return ev;
}
# 3311 "C:\\RTDRUI~1\\TC275_~1\\erika\\src\\ee_oo_api_osek.c"
ISRType
  GetISRID
(
  void
