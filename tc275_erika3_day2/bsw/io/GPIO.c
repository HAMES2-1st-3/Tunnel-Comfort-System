...
//	MODULE_P11.IOCR8.B.PC9=0x10;
	...
	MODULE_P33.IOCR0.B.PC2=0x10; 	// Top r (PIN36)
	MODULE_P33.IOCR0.B.PC1=0x10;	// Top g (PIN38)
	MODULE_P33.IOCR0.B.PC0=0x10;	// Top b (PIN40)

	MODULE_P00.IOCR8.B.PC8 = 0x10;	// Front r (PIN26)
	MODULE_P00.IOCR8.B.PC9 = 0x10;	// Front g (PIN28)
	MODULE_P00.IOCR8.B.PC10 = 0x10;	// Front b (PIN30)
	...
	if(onoff)
		{
			...
			//LED1_SET
			MODULE_P33.OUT.B.P2 = 1; // Top r (PIN36)
			MODULE_P33.OUT.B.P1 = 1; // Top g (PIN38)
			//MODULE_P33.OUT.B.P0 = 1; //BLUE

			//LED2_SET
			MODULE_P00.OUT.B.P8=1; // Front r (PIN26)
			MODULE_P00.OUT.B.P9=1; // Front g (PIN28)
