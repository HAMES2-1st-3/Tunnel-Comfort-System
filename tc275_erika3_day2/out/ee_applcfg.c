 ...
 *
 **************************************************************************/
static VAR(OsEE_SCB, OS_VAR_INIT) osEE_scb_array[(12U)] =
{
 ...
 *
 **************************************************************************/
static VAR(OsEE_SDB, OS_CONST) osEE_sdb_array[(12U)] =
{
  {
  ...
  osEE_tdb_array[15]  =
{
  {
    /* .hdb = */ {
      /* .p_sdb    = */   &osEE_sdb_array[11U],
      /* .p_scb    = */   &osEE_scb_array[11U],
  ...
  },
  {
    /* .hdb = */ {
      /* .p_sdb    = */   &osEE_sdb_array[11U],
      /* .p_scb    = */   &osEE_scb_array[11U],
      /* .isr2_src = */   OSEE_TC_SRC_ASCLIN1RX
    },
    /* .p_tcb          = */ &osEE_tcb_array[1U],
    /* .tid            = */ 1U,
    /* .task_type      = */ OSEE_TASK_TYPE_ISR2,
    /* .task_func      = */ TOF_ISR_HND,
    /* .ready_prio     = */ 132U,
    /* .dispatch_prio  = */ 132U,
    /* .max_num_of_act = */ 1U
  },
...
static VAR(OsEE_SN, OS_VAR_INIT)  osEE_sn_array[14] = {
  {
...
VAR(OsEE_CDB, OS_CONST) osEE_cdb_var = {
  /* .p_ccb                         = */ &osEE_ccb_var,
  /* .p_idle_task                   = */ &osEE_tdb_array[14U],
