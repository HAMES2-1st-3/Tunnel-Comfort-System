...
static VAR(OsEE_SN, OS_VAR_INIT)  osEE_sn_array[19] = {
  {
  ...
  {
    /* .p_next = */ &osEE_sn_array[17U],
    /* .p_tdb  = */ NULL
  },
  {
    /* .p_next = */ &osEE_sn_array[18U],
    /* .p_tdb  = */ NULL
  },
  {
    /* .p_next = */ NULL,
...
VAR(OsEE_CDB, OS_CONST) osEE_cdb_var = {
  /* .p_ccb                         = */ &osEE_ccb_var,
  /* .p_idle_task                   = */ &osEE_tdb_array[19U],
